/**
 * @fileoverview Utility functions for handling PDDL variables.
 * Adapted from procedures.js by fraser@google.com (Neil Fraser), SPDX-License-Identifier: Apache-2.0.
 * @author Anil Agarwal
 */
'use strict';
...
Blockly.Predicates.mutateCallers = function (defBlock) {
  var oldRecordUndo = Blockly.Events.getRecordUndo();
  var predicateBlock = /** @type {!Blockly.Predicates.PredicateBlock} */ (
    defBlock);
